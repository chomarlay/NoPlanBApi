insert into User (id, username, email, password, created_By, created_Date, last_Modified_By, last_Modified_Date) values (30001L, 'noPlanB', 'noPlanB@noplanb.com.au', 'password123','noPlanB', '2019-09-12', 'noPlanB', '2019-09-12' );
insert into User (id, username, email, password, created_By, created_Date, last_Modified_By, last_Modified_Date) values (30002L, 'theodore', 'theodore@chippymonks.com.au', 'password123','theodore', '2019-09-12', 'theodore', '2019-09-12' );
